...
<head>
    ...
    <style>
        ...
        ------------------------------- */
        body {
            background: #000 url('chan.gif') no-repeat center center fixed;
        ...
        <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-4">
            ...
            <div class="col">
                <div class="card h-100">
                    <img src="outstanding.jpg" class="card-img-top">
                    <div class="card-body">
            ...
            <div class="col">
                <div class="card h-100">
                    <img src="singing.jpg" class="card-img-top">
                    <div class="card-body">
            ...
            <div class="col">
                <div class="card h-100">
                    <img src="hakotaward.jpg" class="card-img-top">
                    <div class="card-body">
